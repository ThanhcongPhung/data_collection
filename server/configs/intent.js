...
const QA = [
  ...
  },
  {
    ...
    answer: "Để hủy dịch vụ này, quý khách nhắn tin theo cú pháp “VCB CD HUY” gửi tới số 6167 nhé" +
        "*Hoặc cũng có thể đề nghị hủy trực tiếp tại các phòng giao dịch của Vietcombank ạ"
  },
  {
    scenario: 1,
    question: "Hủy dịch vụ VCBPAY",
    answer: "Quý khách có thể:\n" +
  ...
  },
  {
    ...
    answer: "Quý khách vui lòng liên hệ với điểm giao dịch Vietcombank gần nhất để thực hiện đăng ký ngừng sử dụng dịch vụ VCB-iB@nking ạ."
  },
  {
    scenario: 1,
  ...
  },
  {
    ...
    answer: "Với dịch vụ VCBPAY, quý khách sẽ cảm nhận được sự tiện lợi của ngân hàng khi mọi lúc mọi nơi có thể chủ động thực hiện giao dịch chuyển tiền/thanh toán dịch vụ/nạp tiền điện thoại chỉ với 01 chiếc điện thoại thông minh" +
        "*Ngoài ra, có thể tận hưởng nhiều tiện ích hấp dẫn được tích hợp trên ứng dụng của dịch vụ"
  },
  {
    scenario: 1,
    question: "Tính năng SMS Banking",
    answer: "Dịch vụ VCB-SMS B@nking sẽ mang đến cho quý khách nhiều tiện ích như:\n" +
  ...
  },
  {
    ...
    answer: "Với dịch vụ VCB-Mobile B@nking, quý khách sẽ cảm nhận được sự tiện lợi của ngân hàng khi mọi lúc mọi nơi có thể chủ động thực hiện giao dịch chuyển tiền/thanh toán dịch vụ/nạp tiền điện thoại chỉ với 01 chiếc điện thoại thông minh" +
        "*Ngoài ra, có thể tận hưởng nhiều tiện ích hấp dẫn được tích hợp trên ứng dụng của dịch vụ"
  },
  {
    scenario: 1,
  ...
  },
  {
    ...
    answer: "Thẻ American Express (Amex) là cách mọi người gọi các thẻ thanh toán quốc tế (thẻ tín dụng và thẻ ghi nợ) mang thương hiệu American Express" +
  ...
  },
  {
    ...
    answer: "Thẻ ATM là một loại thẻ theo chuẩn ISO 7810, dùng để thực hiện các " +
  ...
  },
  {
    ...
    answer: "Thẻ tín dụng là thẻ được sử dụng để chi tiêu trước, trả tiền sau trong một hạn mức nhất định do ngân hàng cấp, với thời gian miễn lãi lên đến 50 ngày" +
  ...
  },
  {
    ...
    answer: "Thẻ Ghi nợ là thẻ kết nối với tài khoản thanh toán của bạn mở tại ngân hàng " +
  ...
  },
  {
    ...
    answer: "Để cấp lại thẻ quý khách vui lòng mang Chứng minh nhân dân/Căn cước hoặc Hộ chiếu đến phòng giao dịch Vietcombank gần nhất để được hướng dẫn làm thủ tục cấp lại thẻ" +
  ...
  },
  {
    ...
    answer: "Không có thông tin*Chuyển máy đến phòng chuyên môn để tư vấn thêm*Báo với khách hàng chờ máy"
  },
  {
    scenario: 3,
  ...
  },
  {
    ...
    answer: "Điều kiện mở tài khoản tiết kiệm của Vietcombank khá đơn giản* Quý khách chỉ cần là một trong các đối tượng sau đây:\n" +
  ...
  {
    scenario: 4,
    question: "Hồ sơ vay thế chấp (vay có đảm bảo bằng tài sản như nhà, xe ô tô, xe máy ..)",
  ...
  {
    scenario: 4,
    question: "Hồ sơ vay cầm cố giấy tờ có giá (vay cầm cố các GTCG như tín phiếu kho bạc, trái phiếu Chính phủ)",
  ...
  },
  {
    ...
    answer: "Vui lòng gọi điện thoại đến số Hotline hoặc đem theo giấy tờ tuỳ thân trực tiếp đến các điểm giao dịch của Vietcombank để đề nghị tra soát, khiếu nại" +
  ...
  },
  {
    ...
    answer: "Hiện tại, VCB chưa hỗ trợ dịch vụ chuyển tiền qua tin nhắn mong quý khách thông cảm"
  },
  {
    scenario: 5,
    question: "Phí chuyển tiền Mobile banking",
    answer: "Cùng ngân hàng:" +
...
const INTENT = [
  ...
  },
  {
    ...
    servant: "Bạn có thể tra cứu thông tin của các loại thẻ ở dưới thanh search." +
        " Nếu thông tin nào không có thì có thể nói khách hàng chờ máy để chuyển sang phòng ban chuyên môn." +
  ...
  },
  {
    ...
    servant: "Trước tiên hãy hỏi khách hàng mục đích vay là gì và muốn vay theo hình thức nào." +
        "Sau đó hãy xác nhận với khách hàng thông tin cá nhân để tư vấn được tốt hơn được không. " +
        "Nếu đồng ý thì bạn hãy xác thực thông tin người dùng: Họ tên, tuổi, nghề nghiệp, thu nhập, giấy tờ đảm bảo tài sản." +
        " Sau đó dựa vào những thông tin  như trên và thông tin trong thanh search " +
  ...
  },
  {
    ...
    servant: "Hồ sơ phát hành của tất cả các loại thẻ đều giống nhau. " +
        "Bạn có thể tra cứu thông tin của các loại thẻ ở dưới thanh search." +
  ...
  },
  {
    ...
    servant: "Trước tiên hãy hỏi khách hàng mục đích vay là gì và muốn vay theo hình thức nào." +
        "Sau đó hãy xác nhận với khách hàng thông tin cá nhân để tư vấn được tốt hơn được không. " +
        "Nếu đồng ý thì bạn hãy xác thực thông tin người dùng: Họ tên, tuổi, nghề nghiệp, thu nhập, giấy tờ đảm bảo tài sản." +
        "Có thể hẹn khách hàng đến phòng giao dịch để tư vấn tốt hơn"
  },
  {
    // #7
  ...
  },
  {
    ...
    slot: ["name", "cmnd", "four_last_digits"],
    servant: "Bạn hãy xác thực thông tin tên, số điện thoại, CMND, ngày sinh, hạn mức chi tiêu của khách hàng. " +
        "Mỗi thông tin xác nhận lại một lần. " +
        "Sau khi đã đủ 5 bước thì thông báo cho khách hàng là đã khóa thẻ khẩn cấp thành công"
  ...
  },
  {
    ...
    servant: "Bạn hãy xác thực thông tin tên, số điện thoại, CMND, ngày sinh, 4 số cuối tài khoản của khách hàng. " +
        "Mỗi thông tin xác nhận lại một lần. " +
        "Sau khi đã đủ 5 bước thì thông báo cho khách hàng số dư hiện tại trong tài khoản." +
  ...
  },
  {
    ...
    slot: ["name", "cmnd", "four_last_digits"],
    servant: "Bạn hãy xác thực thông tin tên, số điện thoại, CMND, ngày sinh, 4 số cuối tài khoản của khách hàng, hạn mức chi tiêu hiện tại của thẻ." +
        "Mỗi thông tin xác nhận lại một lần. " +
  ...
  //18
  {
    ...
    servant: "bạn hãy hỏi về thời điểm giao dịch của khách hàng. Đang giao dịch ngoài ATM hay online trên ứng dụng. " +
        "Sau khi đã tìm hiểu nguyên nhân nếu khách hàng yêu cầu khóa thẻ khẩn cấp thì bạn hãy xác thực thông tin tên, số điện thoại, 4 số cuối tài khoản của khách hàng." +
        "Mỗi thông tin xác nhận lại một lần. Sau khi thành công thì sẽ báo cho phòng chuyên môn để giải quyết khẩn cấp cho khách. " +
